export const translations = {
  en: {
    ...
    questions: {
      ...
      matrixRequired: 'Please rate every item before continuing.',
      matrixRemaining: '{n} left to rate',
      matrixAllRated: 'Every item is rated',
  ...
  ru: {
    ...
    questions: {
      ...
      matrixRequired: 'Оцените каждый пункт, чтобы продолжить.',
      matrixRemaining: 'Осталось оценить: {n}',
      matrixAllRated: 'Все пункты оценены',
  ...
  fr: {
    ...
    questions: {
      ...
      matrixRequired: 'Veuillez noter chaque élément avant de continuer.',
      matrixRemaining: '{n} restant(s) à noter',
      matrixAllRated: 'Tous les éléments sont notés',
  ...
  es: {
    ...
    questions: {
      ...
      matrixRequired: 'Valore cada elemento antes de continuar.',
      matrixRemaining: '{n} pendiente(s) de valorar',
      matrixAllRated: 'Todos los elementos están valorados',
